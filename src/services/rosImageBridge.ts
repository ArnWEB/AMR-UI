...
// import { ROS_CONFIG, AMRId, CameraAngle, ROSImageData, ROSConnectionState } from '@/config/rosConfig';
...
// let ros: any = null;
// const imageSubscribers: Map<string, any> = new Map();

// const imageCallbacks: Map<string, (data: ROSImageData) => void> = new Map();
...
// ): () => void {
//   const streamKey = `${amrId}:${angle}`;
//   imageCallbacks.set(streamKey, callback);

//   const doSubscribe = () => {
//     if (!ros || !ros.isConnected) {
//       console.warn('ROS not connected, cannot subscribe to', streamKey);
//       return;
//     }

//     const topicName = ROS_CONFIG.topics[amrId][angle];
  
//     const existingSub = imageSubscribers.get(streamKey);
//     if (existingSub) {
...
//     imageSubscribers.set(streamKey, topic);
//   };
...
//     return () => imageCallbacks.delete(streamKey);
//   }

//   doSubscribe();

//   return () => {
//     imageCallbacks.delete(streamKey);
//     const sub = imageSubscribers.get(streamKey);
//     if (sub) {
//       sub.unsubscribe();
//       imageSubscribers.delete(streamKey);
//     }
//   };
// }

// export function unsubscribeFromImage(amrId: AMRId, angle: CameraAngle): void {
//   const streamKey = `${amrId}:${angle}`;
//   const topic = imageSubscribers.get(streamKey);
//   if (topic) {
//     topic.unsubscribe();
//     imageSubscribers.delete(streamKey);
//   }
