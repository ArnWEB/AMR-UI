...
export const LiveFeed: React.FC = () => {
    ...
    const renderCameraFeed = useCallback((ctx: CanvasRenderingContext2D, width: number, height: number, amrId: string, status: string) => {
        ...
        // Center reticle/crosshair - brand yellow
        ...
        <div className="flex flex-col h-full bg-slate-100 dark:bg-slate-900">
            ...
            <div className={`flex-1 relative ${expandedAMR ? 'fixed inset-0 z-50 bg-slate-900' : ''}`}>
                ...
                <div className="absolute top-4 right-4">
                    <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium ${selectedCameraState?.isConnected
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="absolute top-1 right-1">
                                    <div className={`w-2 h-2 rounded-full ${state?.isConnected
